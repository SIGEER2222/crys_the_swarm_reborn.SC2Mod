...
| 凯瑞甘 / `Kerrigan` | 6 | 3 | 1 | 0 | 15 | 3 | 6 | 25 |
| 阿塔尼斯 / `Artanis` | 7 | 5 | 0 | 0 | 15 | 3 | 6 | 28 |
| 斯旺 / `Swann` | 9 | 6 | 0 | 0 | 15 | 3 | 6 | 25 |
| 扎加拉 / `Zagara` | 6 | 2 | 1 | 0 | 15 | 3 | 6 | 23 |
| 沃拉尊 / `Vorazun` | 7 | 3 | 0 | 0 | 15 | 3 | 6 | 26 |
| 凯拉克斯 / `Karax` | 8 | 5 | 0 | 0 | 15 | 3 | 6 | 26 |
| 阿巴瑟 / `Abathur` | 12 | 2 | 0 | 0 | 15 | 3 | 6 | 22 |
| 阿拉纳克 / `Alarak` | 7 | 3 | 0 | 0 | 15 | 3 | 6 | 19 |
| 诺娃 / `Nova` | 11 | 5 | 0 | 0 | 15 | 3 | 6 | 25 |
| 斯托科夫 / `Stukov` | 5 | 9 | 0 | 0 | 15 | 3 | 6 | 29 |
...
- `commanders/<Commander>/units.json` / `buildings.json` / `heroes.json`：按 `UnitData.EditorCategories.ObjectType` 切分，附带入口按钮、图标引用、`abilities` 技能/面板按钮摘要，以及 `production` 代表入口与 `production_options` 全部候选面板费用/耗时；`unit` 内补充 `supply_raw` / `supply_cost` / `supply_provided`。
