...
口径：征召兵、皇家卫队、帝国支援面板必须拆成资源、单位和面板三条验证。
...
| 帝国冲锋队 | `MoveHoldPosition` | 原地防御 | `move,HoldPos` | - | 命令选中的单位待在原地，并攻击射程内的敌方目标。接受命令的单位不会对敌人进行追击或移向敌人与其交战。 |
| 帝国冲锋队 | `MovePatrol` | 巡逻 | `move,Patrol` | - | 命令选中的单位在当前位置与目标区域间进行巡逻。巡逻的单位会对敌人发起攻击或移向附近的敌人与其交战。 |
| 帝国冲锋队 | `AttackWithoutSimpleCommandCard` | 攻击 | `attack,Execute` | - | 命令选中的单位移动到目标地点，并对沿途遭遇的敌人发起攻击。收到攻击一个目标的命令后，单位会持续攻击该目标，直到对方被消灭。 |
...
| 帝国 火箭筒 冲锋队 | `MoveHoldPosition` | 原地防御 | `move,HoldPos` | - | 命令选中的单位待在原地，并攻击射程内的敌方目标。接受命令的单位不会对敌人进行追击或移向敌人与其交战。 |
| 帝国 火箭筒 冲锋队 | `MovePatrol` | 巡逻 | `move,Patrol` | - | 命令选中的单位在当前位置与目标区域间进行巡逻。巡逻的单位会对敌人发起攻击或移向附近的敌人与其交战。 |
| 帝国 火箭筒 冲锋队 | `AttackWithoutSimpleCommandCard` | 攻击 | `attack,Execute` | - | 命令选中的单位移动到目标地点，并对沿途遭遇的敌人发起攻击。收到攻击一个目标的命令后，单位会持续攻击该目标，直到对方被消灭。 |
...
| 帝国 火焰器 冲锋队 | `MoveHoldPosition` | 原地防御 | `move,HoldPos` | - | 命令选中的单位待在原地，并攻击射程内的敌方目标。接受命令的单位不会对敌人进行追击或移向敌人与其交战。 |
| 帝国 火焰器 冲锋队 | `MovePatrol` | 巡逻 | `move,Patrol` | - | 命令选中的单位在当前位置与目标区域间进行巡逻。巡逻的单位会对敌人发起攻击或移向附近的敌人与其交战。 |
| 帝国 火焰器 冲锋队 | `AttackWithoutSimpleCommandCard` | 攻击 | `attack,Execute` | - | 命令选中的单位移动到目标地点，并对沿途遭遇的敌人发起攻击。收到攻击一个目标的命令后，单位会持续攻击该目标，直到对方被消灭。 |
...
| 天空之怒 | `VikingMengskAttackDamage` | 战术调整 | `-` | HaveMengskVeterancyVikingMengskGELevel3 | 变形后，该单位的攻击伤害提高{(Behavior,VikingMengskAirAttackDamage,DamageResponse.ModifyFra... |
| 天空之怒 | `VikingMengskCheatDeath` | 不死鸟协议 | `-` | HaveVikingMengskCheatDeathCooldown | 该单位承受致命伤害时，天空之怒变形为战机模式并且临时获得一个屏障，吸收{Behavior,VikingMengskCheatDeath,DamageRes... |
...
| 名称 | Catalog ID | 解析 Unit | 属性 | 费用/人口/生命 | 备注 |
|---|---|---|---|---|---|
| 征兵中心 | `CommandCenterMengsk` | `CommandCenterMengsk` | Ground; Armored/Mechanical/Structure | 矿:400 气:- 人口字段:15 生命:1500 | 基础建筑，用于接收采集到的资源和转化帝国劳工与帝国冲锋队。自体可以升空。 / 开启： / - 帝国劳工 / - 帝国冲锋队 / - 劳工和冲锋队员可以... |
| 补给地堡 | `BunkerDepotMengsk` | `BunkerDepotMengsk` | Ground; Armored/Mechanical/Structure | 矿:100 气:- 人口字段:12 生命:400 | 可以提供补给的防御性建筑。 / 充足的补给可以让你制造更多的单位。 / 冲锋队员可在地堡内战斗。 / 加成：地堡内的单位射程+{Behavior,Bu... |
...
|---|---|---|---|---|---|
| 征兵中心 | `CommandCenterMengsk` | `CommandCenterMengsk` | Ground; Armored/Mechanical/Structure | 矿:400 气:- 人口字段:15 生命:1500 | 基础建筑，用于接收采集到的资源和转化帝国劳工与帝国冲锋队。自体可以升空。 / 开启： / - 帝国劳工 / - 帝国冲锋队 / - 劳工和冲锋队员可以... |
| 兵营 | `BarracksMengsk` | `BarracksMengsk` | Ground; Armored/Mechanical/Structure | 矿:150 气:- 人口字段:- 生命:1000 | 皇家卫队步兵训练设施。 / 开启： / - 壁垒卫士 |
| 重工厂 | `FactoryMengsk` | `FactoryMengsk` | Ground; Armored/Mechanical/Structure | 矿:150 气:100 人口字段:- 生命:1250 | 皇家卫队战车生产设施。 / 开启： / - 冲击分队 |
| 星港 | `StarportMengsk` | `StarportMengsk` | Ground; Armored/Mechanical/Structure | 矿:150 气:100 人口字段:- 生命:1300 | 帝国和皇家卫队空中单位生产设施。 / 开启： / - 帝国仲裁机 / - 帝国见证者 / - 天空之怒 |
| 工程站 | `EngineeringBayMengsk` | `EngineeringBayMengsk` | Ground; Armored/Mechanical/Structure | 矿:125 气:- 人口字段:- 生命:850 | 为帝国冲锋队和建筑提供升级方案。 / 开启： / - 劳工和冲锋队员可以建造导弹塔 / - 劳工和冲锋队员可以建造大地碎裂炮 |
...
| 名称 | Catalog ID | 解析 Unit | 属性 | 费用/人口/生命 | 备注 |
|---|---|---|---|---|---|
| 帝国劳工 | `SCVMengsk` | `SCVMengsk` | Ground; Biological/Light/Mechanical | 矿:40 气:- 人口字段:-1 生命:45 | 基础工作单位。用于采集资源、建造人类建筑和修理。可以切换成冲锋队员。 / 可以对地。 |
| 帝国冲锋队 | `TrooperMengsk` | `TrooperMengsk` | Ground; Biological/Light | 矿:40 气:- 人口字段:-1 生命:45 | 通用型步兵。可以装备多种武器以应对不同战况。可以切换成一身劳工服。 / 可以对地和对空。 |
| 帝国 火箭筒 冲锋队 | `TrooperMengskAA` | `TrooperMengskAA` | Ground; Biological/Light | 矿:200 气:- 人口字段:-1 生命:45 | 专业对空攻击手。可以切换为劳工。 / 可以对地和对空。 |
| 帝国 火焰器 冲锋队 | `TrooperMengskFlamethrower` | `TrooperMengskFlamethrower` | Ground; Armored/Biological | 矿:200 气:- 人口字段:-1 生命:145 | 专业对空攻击手。可以切换为劳工。 / 可以对地和对空。 |
| 帝国 突击手 冲锋队 | `TrooperMengskImproved` | `TrooperMengskImproved` | Ground; Biological/Light | 矿:200 气:- 人口字段:-1 生命:45 | 升级后的通用型步兵。可以切换为劳工。 / 可以对地和对空。 |
| 壁垒卫士 | `MarauderMengsk` | `MarauderMengsk` | Ground; Armored/Biological | 矿:125 气:350 人口字段:-4 生命:300 | 皇家卫队重型突击步兵。 / 可以对地。 |
| 元首鬼影 | `GhostMengsk` | `GhostMengsk` | Ground; Biological/Psionic | 矿:200 气:500 人口字段:-4 生命:200 | 皇家卫队特工。可以使用“焰能爆燃”和“EMP震爆”。可以对“皇家军校”中建造并发射的战术飞弹进行制导。 / 可以对空和对地。 |
| 帝国仲裁机 | `MedivacMengsk` | `MedivacMengsk` | Air; Armored/Mechanical | 矿:100 气:50 人口字段:-2 生命:150 | 空中运输单位。治疗附近的生物单位。可以使用后燃推进系统。 |
| 冲击分队 | `SiegeTankMengsk` | `SiegeTankMengsk` | Ground; Armored/Mechanical | 矿:150 气:425 人口字段:-6 生命:350 | 皇家卫队重型坦克。可以切换成攻城模式，提供远程火力支援。 / 可以对地。 |
| 攻城坦克 | `SiegeTankMengskSieged` | `SiegeTankMengskSieged` | Ground; Armored/Mechanical | 矿:150 气:425 人口字段:-6 生命:350 | 皇家卫队重型坦克。可切换成坦克模式，提供机动坦克火力支援。 / 可以对地。 |
| 黑色战锤 | `ThorMengsk` | `ThorMengsk` | Ground; Armored/Massive/Mechanical | 矿:300 气:600 人口字段:-8 生命:600 | 皇家卫队重型攻击机甲。可以使用“掩护射击模式”。 / 可以对空和对地。 |
| 天空之怒 | `VikingMengskFighter` | `VikingMengskFighter` | Air; Armored/Mechanical | 矿:150 气:375 人口字段:-4 生命:270 | 坚固的皇家卫队支援型飞行器。装填了威力强大的反主力舰对空飞弹。可以切换至突击模式来攻击地面单位。 / 可以对空。 |
| 天空之怒 | `VikingMengskAssault` | `VikingMengskAssault` | Ground; Armored/Mechanical | 矿:150 气:375 人口字段:-4 生命:270 | 坚固的火力支援单位。进入战机模式后可攻击空中单位。 / 可以对地。 |
| 奥古斯特格勒的骄傲 | `BattlecruiserMengsk` | `BattlecruiserMengsk` | Air; Armored/Massive/Mechanical | 矿:400 气:900 人口字段:-10 生命:800 | 强大的皇家卫队战舰。可以使用大和炮与战术跳跃。在星港中建造。 / 可以对地和对空。 |
| 帝国见证者 | `RavenMengsk` | `RavenMengsk` | Air; Mechanical | 矿:100 气:100 人口字段:-2 生命:350 | 空中支援单位。可以使用“爱国者模式”，教导附近的盟友。 / 侦测单位 |
| 帝国见证者 | `RavenMengskSieged` | `RavenMengskSieged` | Air; Mechanical | 矿:100 气:100 人口字段:-2 生命:350 | 空中支援单位。 / 侦测单位 |
...
| 征兵中心 | `CommandCenterMengsk` | `CommandCenterMengsk` | Ground; Armored/Mechanical/Structure | 矿:400 气:- 人口字段:15 生命:1500 | 基础建筑，用于接收采集到的资源和转化帝国劳工与帝国冲锋队。自体可以升空。 / 开启： / - 帝国劳工 / - 帝国冲锋队 / - 劳工和冲锋队员可以... |
| 补给地堡 | `BunkerDepotMengsk` | `BunkerDepotMengsk` | Ground; Armored/Mechanical/Structure | 矿:100 气:- 人口字段:12 生命:400 | 可以提供补给的防御性建筑。 / 充足的补给可以让你制造更多的单位。 / 冲锋队员可在地堡内战斗。 / 加成：地堡内的单位射程+{Behavior,Bu... |
| 导弹塔 | `MissileTurretMengsk` | `MissileTurretMengsk` | Ground; Armored/Mechanical/Structure | 矿:100 气:- 人口字段:- 生命:250 | 防空建筑。 / 可以对空。 / 侦测单位 |
| 兵营 | `BarracksMengsk` | `BarracksMengsk` | Ground; Armored/Mechanical/Structure | 矿:150 气:- 人口字段:- 生命:1000 | 皇家卫队步兵训练设施。 / 开启： / - 壁垒卫士 |
| 重工厂 | `FactoryMengsk` | `FactoryMengsk` | Ground; Armored/Mechanical/Structure | 矿:150 气:100 人口字段:- 生命:1250 | 皇家卫队战车生产设施。 / 开启： / - 冲击分队 |
| 星港 | `StarportMengsk` | `StarportMengsk` | Ground; Armored/Mechanical/Structure | 矿:150 气:100 人口字段:- 生命:1300 | 帝国和皇家卫队空中单位生产设施。 / 开启： / - 帝国仲裁机 / - 帝国见证者 / - 天空之怒 |
| 工程站 | `EngineeringBayMengsk` | `EngineeringBayMengsk` | Ground; Armored/Mechanical/Structure | 矿:125 气:- 人口字段:- 生命:850 | 为帝国冲锋队和建筑提供升级方案。 / 开启： / - 劳工和冲锋队员可以建造导弹塔 / - 劳工和冲锋队员可以建造大地碎裂炮 |
| 军械库 | `ArmoryMengsk` | `ArmoryMengsk` | Ground; Armored/Mechanical/Structure | 矿:150 气:100 人口字段:- 生命:750 | 为重工厂和星港单位提供升级方案。 / 开启： / - 可以在重工厂中建造黑色战锤 |
| 聚变芯体 | `FusionCoreMengsk` | `FusionCoreMengsk` | Ground; Armored/Mechanical/Structure | 矿:150 气:150 人口字段:- 生命:750 | 为星港单位提供升级方案。 / 开启： / - 可以在星港中建造奥古斯格勒的骄傲 |
| 皇家军校 | `GhostAcademyMengsk` | `GhostAcademyMengsk` | Ground; Armored/Mechanical/Structure | 矿:150 气:50 人口字段:- 生命:1250 | 为壁垒卫士和元首鬼影提供升级方案。可以为元首鬼影建造战术飞弹。 / 开启： / - 可以在兵营中训练元首鬼影 |
| 大地碎裂炮 | `ArtilleryMengsk` | `ArtilleryMengsk` | Ground; Armored/Mechanical/Structure | 矿:150 气:100 人口字段:- 生命:400 | 随机轰炸附近一处目标位置，对区域内的地面单位造成伤害。在顶部面板中开启“辐射打击”能力。 / 可以对地。 |
...
| 征兵中心 | `TrooperMengskDropTrain` | 冲锋队高空轨道空投舱 | `-` | HaveTrooperMengskDropTrain | 劳工和冲锋队员会被直接输送至该建筑的集结点所在处。 |
| 征兵中心 | `CancelBuilding` | 取消 | `BuildInProgress,Cancel` | - | 取消建造，摧毁尚未建造完成的建筑并返还部分资源。 |
...
| 补给地堡 | `BunkerDepotMengskLoad` | 装载 | `BunkerMengskTransport,Load` | - | 将劳工和冲锋队员载入补给地堡。 |
| 补给地堡 | `BunkerDepotMengskUnloadAll` | 全部卸载 | `BunkerMengskTransport,UnloadAll` | - | 卸载所有单位。 |
| 补给地堡 | `CancelBuilding` | 取消 | `BuildInProgress,Cancel` | - | 取消建造，摧毁尚未建造完成的建筑并返还部分资源。 |
...
| 重工厂 | `SiegeTankMengsk` | 建造冲击分队 | `FactoryMengskTrain,Train1` | - | 皇家卫队重型坦克。可以切换成攻城模式，提供远程火力支援。 / 可以对地。 |
| 重工厂 | `ThorMengsk` | 建造黑色战锤 | `FactoryMengskTrain,Train2` | - | 皇家卫队重型攻击机甲。可以使用“掩护射击模式”。 / 可以对空和对地。 |
| 重工厂 | `CancelBuilding` | 取消 | `BuildInProgress,Cancel` | - | 取消建造，摧毁尚未建造完成的建筑并返还部分资源。 |
| 星港 | `VikingMengskFighter` | 建造天空之怒 | `StarportMengskTrain,Train3` | - | 坚固的皇家卫队支援型飞行器。装填了威力强大的反主力舰对空飞弹。可以切换至突击模式来攻击地面单位。 / 可以对空。 |
| 星港 | `MedivacMengsk` | 建造帝国仲裁机 | `StarportMengskTrain,Train1` | - | 空中运输单位。治疗附近的生物单位。可以使用后燃推进系统。 |
| 星港 | `RavenMengsk` | 建造帝国见证者 | `StarportMengskTrain,Train2` | - | 空中支援单位。可以使用“爱国者模式”，教导附近的盟友。 / 侦测单位 |
| 星港 | `BattlecruiserMengsk` | 建造奥古斯格勒的骄傲 | `StarportMengskTrain,Train4` | - | 强大的皇家卫队战舰。可以使用大和炮与战术跳跃。在星港中建造。 / 可以对地和对空。 |
| 星港 | `CancelBuilding` | 取消 | `BuildInProgress,Cancel` | - | 取消建造，摧毁尚未建造完成的建筑并返还部分资源。 |
...
| 工程站 | `CancelBuilding` | 取消 | `BuildInProgress,Cancel` | - | 取消建造，摧毁尚未建造完成的建筑并返还部分资源。 |
| 军械库 | `MedivacMengskSiegeTankAirliftResearch` | 研究火炮稳定器 | `ArmoryMengskResearch,Research1` | - | 允许攻城模式下的冲击分队在被帝国仲裁机吊挂时可以朝空中目标开火，只是开火间隔较长。 |
...
| 军械库 | `MechTransformationSpeedMengsk` | 研究智能伺服器 | `ArmoryMengskResearch,Research3` | - | 缩短冲击分队, 黑色战锤和天空之怒的变形时间。 |
| 军械库 | `CancelBuilding` | 取消 | `BuildInProgress,Cancel` | - | 取消建造，摧毁尚未建造完成的建筑并返还部分资源。 |
...
| 聚变芯体 | `CancelBuilding` | 取消 | `BuildInProgress,Cancel` | - | 取消建造，摧毁尚未建造完成的建筑并返还部分资源。 |
...
| 皇家军校 | `CancelBuilding` | 取消 | `BuildInProgress,Cancel` | - | 取消建造，摧毁尚未建造完成的建筑并返还部分资源。 |
| 大地碎裂炮 | `ArtilleryMengskExperimentalStrikePassive` | 辐射打击 | `-` | - | 该建筑可以装填一枚试验性弹头，瞄准地图上的任意位置进行发射。弹头会随机落在目标位置附近，使整个区域浸泡在充满辐射的生化材料中，任何进入其中的敌人每秒承受{... |
...
| 帝国 火焰器 冲锋队 | `TrooperMengskSpecializeFlamethrower` | 装备CPO-7火蜥火焰喷射器 | `TrooperMengskSpecializeFlamethrower,Execute` | - | 给冲锋队装备更强力的武器，尤其擅长对付地面轻型单位。该单位死亡时，其所装备的武器会掉落在地上，可以被其他帝国冲锋队员拾取。 / 可以对地。 |
| 帝国 火焰器 冲锋队 | `TrooperMengskSpecializeAA` | 装备冰雹发射器 | `TrooperMengskSpecializeAA,Execute` | - | 给冲锋队装备更强力的武器，尤其擅长对付空中重甲单位。该单位死亡时，其所装备的武器会掉落在地上，可以被其他帝国冲锋队员拾取。 / 可以对地和对空。 |
| 帝国 突击手 冲锋队 | `TrooperMengskImperialMandateGeneration` | 人民的意志 | `-` | HavePropagandaBlastMengsk | 该单位被帝国见证者教导后，其提供的帝国支持度增加{Effect,PropagandaMengskTopbarRegenDummy,Amount*Effec... |
| 帝国 突击手 冲锋队 | `TrooperMengskSpecializeImproved` | 装备B-2大口径轻机枪 | `TrooperMengskSpecializeImproved,Execute` | - | 给冲锋队装备更强力的武器，能有效对付所有类型的敌方单位。该单位死亡时，其所装备的武器会掉落在地上，可以被其他帝国冲锋队员拾取。 / 可以对地和对空。 |
| 帝国 突击手 冲锋队 | `TrooperMengskSpecializeFlamethrower` | 装备CPO-7火蜥火焰喷射器 | `TrooperMengskSpecializeFlamethrower,Execute` | - | 给冲锋队装备更强力的武器，尤其擅长对付地面轻型单位。该单位死亡时，其所装备的武器会掉落在地上，可以被其他帝国冲锋队员拾取。 / 可以对地。 |
| 帝国 突击手 冲锋队 | `TrooperMengskSpecializeAA` | 装备冰雹发射器 | `TrooperMengskSpecializeAA,Execute` | - | 给冲锋队装备更强力的武器，尤其擅长对付空中重甲单位。该单位死亡时，其所装备的武器会掉落在地上，可以被其他帝国冲锋队员拾取。 / 可以对地和对空。 |
| ... | ... | ... | ... | ... | 还有 24 项，后续从 command_cards.json 继续展开 |
...
[XM_DBG][INFO][ROSTER_LOAD] commander=Mengsk stage=power_fusion units=16 buildings=11 result=ok
