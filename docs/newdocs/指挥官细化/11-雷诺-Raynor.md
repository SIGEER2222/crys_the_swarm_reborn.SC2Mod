...
口径：无常规英雄；休伯利安/女妖为空降召唤单位，暂按面板召唤和特殊机制处理。
...
| 名称 | Catalog ID | 解析 Unit | 属性 | 费用/人口/生命 | 备注 |
|---|---|---|---|---|---|
| 轨道控制基地 | `OrbitalCommand` | `OrbitalCommand` | Ground; Armored/Mechanical/Structure | 矿:550 气:- 人口字段:15 生命:1500 护盾:- 能量:200 | 使指挥中心升级为轨道控制基地，并启用析像扫描和轨道空投：矿骡技能。无法装载SCV。 |
...
| 名称 | Catalog ID | 解析 Unit | 属性 | 费用/人口/生命 | 备注 |
|---|---|---|---|---|---|
| 陆战队员 | `Marine` | `Marine` | Ground; Biological/Light | 矿:50 气:- 人口字段:-1 生命:45 护盾:- 能量:- | 通用型步兵。 / 可以对地和对空。 |
| 秃鹫 | `Vulture` | `Vulture` | -; - | 矿:- 气:- 人口字段:- 生命:- 护盾:- 能量:- | 动作迅捷的作战单位。能够部署蜘蛛雷。 / 可以对地。 |
| 医疗兵 | `Medic` | `Medic` | -; - | 矿:- 气:- 人口字段:- 生命:- 护盾:- 能量:- | 支援型单位。治疗附近的生物单位。 |
| 火蝠 | `Firebat` | `Firebat` | -; - | 矿:- 气:- 人口字段:- 生命:- 护盾:- 能量:- | 专业反步兵作战单位。 / 可以对地。 |
| 维京战机 | `Viking` | `Viking, VikingFighter` | -; - | 矿:- 气:- 人口字段:- 生命:- 护盾:- 能量:- | 坚固的火力支援型空中单位，配备有强大的反主力舰飞弹。进入机甲模式后可攻击地面单位。 / 可以对空 |
...
| 女妖 | `Banshee` | `Banshee` | Air; Light/Mechanical | 矿:150 气:100 人口字段:-3 生命:140 护盾:- 能量:200 | 战术打击飞行器。可升级隐形技能。 / 可以对地。 |
| 攻城坦克 | `Siege Tank` | `SiegeTank` | Ground; Armored/Mechanical | 矿:150 气:125 人口字段:-3 生命:175 护盾:- 能量:- | 重型坦克。可切换至攻城模式来提供远程炮火。 / 可以对地。 |
| 战列巡航舰 | `Battlecruiser` | `Battlecruiser, FusionCore` | Air; Armored/Massive/Mechanical | 矿:400 气:300 人口字段:-6 生命:550 护盾:- 能量:0 | 强大的战舰。可以使用大和炮和战术跳跃。 / 可以对地和对空。 |
...
| 名称 | Catalog ID | 解析 Unit | 属性 | 费用/人口/生命 | 备注 |
|---|---|---|---|---|---|
| 地堡 | `Bunker` | `Bunker` | Ground; Armored/Mechanical/Structure | 矿:100 气:- 人口字段:- 生命:400 护盾:- 能量:- | 防御工事。 / 步兵单位在地堡内作战。 / 效果加成：舱载单位射程增加1。 |
