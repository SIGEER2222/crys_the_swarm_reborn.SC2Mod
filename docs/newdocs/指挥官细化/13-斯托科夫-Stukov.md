...
| 名称 | Catalog ID | 解析 Unit | 属性 | 费用/人口/生命 | 备注 |
|---|---|---|---|---|---|
| 被感染的补给站 | `StukovInfestedSupplyDepot` | `SISupplyDepot` | Ground; Armored/Biological/Mechanical/Structure | 矿:100 气:- 人口字段:8 生命:350 护盾:- 能量:- | 为人类部队提供补给， / 提高本方单位数量上限。 / 补给站可以降下，允许地面单位出入。 |
| 被感染的精炼厂 | `StukovInfestedRefinery` | `SIRefinery` | Ground; Armored/Biological/Mechanical/Structure | 矿:75 气:- 人口字段:- 生命:500 护盾:- 能量:- | 建造在瓦斯气泉上，用于采集高能瓦斯。 |
| 被感染的平民建筑 | `StukovInfestedCivilianStructure` | `SICivilianStructure` | Ground; Armored/Biological/Mechanical/Structure | 矿:200 气:- 人口字段:- 生命:1000 护盾:- 能量:- | 民用住宅。定期孵化被感染的步兵。 / 开启： / - 被感染的平民 |
| 被感染的指挥中心 | `StukovInfestedCommandCenter` | `SICommandCenter` | Ground; Armored/Biological/Mechanical/Structure | 矿:400 气:- 人口字段:15 生命:1500 护盾:- 能量:- | 基础建筑，用于接收采集到的资源。可以生成菌毯，喂养附近的异虫建筑。可以使用站起技能。 / 开启： / - 被感染的SCV / - 王虫 |

### 特殊建筑候选

| 名称 | Catalog ID | 解析 Unit | 属性 | 费用/人口/生命 | 备注 |
|---|---|---|---|---|---|
| 被感染的兵营 | `StukovInfestedBarracks` | `SIBarracks` | Ground; Armored/Biological/Mechanical/Structure | 矿:150 气:- 人口字段:- 生命:1000 护盾:- 能量:- | 步兵训练设施。 / 开启： / - 被感染的陆战队员 |
| 被感染的补给站 | `StukovInfestedSupplyDepot` | `SISupplyDepot` | Ground; Armored/Biological/Mechanical/Structure | 矿:100 气:- 人口字段:8 生命:350 护盾:- 能量:- | 为人类部队提供补给， / 提高本方单位数量上限。 / 补给站可以降下，允许地面单位出入。 |
| 被感染的精炼厂 | `StukovInfestedRefinery` | `SIRefinery` | Ground; Armored/Biological/Mechanical/Structure | 矿:75 气:- 人口字段:- 生命:500 护盾:- 能量:- | 建造在瓦斯气泉上，用于采集高能瓦斯。 |
| 被感染的军械库 | `StukovInfestedArmory` | `SIArmory` | Ground; Armored/Biological/Mechanical/Structure | 矿:150 气:100 人口字段:- 生命:750 护盾:- 能量:- | 为被感染的重工厂和被感染的星港单位提供升级方案。 |
| 被感染的平民建筑 | `StukovInfestedCivilianStructure` | `SICivilianStructure` | Ground; Armored/Biological/Mechanical/Structure | 矿:200 气:- 人口字段:- 生命:1000 护盾:- 能量:- | 民用住宅。定期孵化被感染的步兵。 / 开启： / - 被感染的平民 |
| 被感染的星港 | `StukovInfestedStarport` | `SIStarport` | Ground; Armored/Biological/Mechanical/Structure | 矿:150 气:100 人口字段:- 生命:1300 护盾:- 能量:- | 空中单位生产设施。 / 开启： / - 被感染的解放者 |
| 被感染的指挥中心 | `StukovInfestedCommandCenter` | `SICommandCenter` | Ground; Armored/Biological/Mechanical/Structure | 矿:400 气:- 人口字段:15 生命:1500 护盾:- 能量:- | 基础建筑，用于接收采集到的资源。可以生成菌毯，喂养附近的异虫建筑。可以使用站起技能。 / 开启： / - 被感染的SCV / - 王虫 |
| 被感染的重工厂 | `StukovInfestedFactory` | `SIFactory` | Ground; Armored/Biological/Mechanical/Structure | 矿:150 气:100 人口字段:- 生命:1250 护盾:- 能量:- | 战车生产设施。 / 开启： / - 被感染的响尾蛇战车 |
| 进化腔 | `StukovEvolutionChamber` | `SIEngineeringBay, SIEvolutionChamber` | Ground; Armored/Biological/Mechanical/Structure | 矿:125 气:- 人口字段:- 生命:850 护盾:- 能量:- | 为被感染的步兵和建筑提供升级方案。 / 开启： / - 使被感染的SCV可以建造被感染的导弹塔 |
...
| 名称 | Catalog ID | 解析 Unit | 属性 | 费用/人口/生命 | 备注 |
|---|---|---|---|---|---|
| 被感染的攻城坦克 | `StukovInfestedSiegeTank` | `StukovInfestedSiegeTank, SICocoonInfestedSiegeTank` | Ground; Armored/Biological/Mechanical | 矿:200 气:100 人口字段:-3 生命:200 护盾:- 能量:- | 重型坦克。让自己站起后可提供机动的坦克火力支援。可以使用深槽虫道技能快速移动至任何有菌毯的可见位置。 / 可以对地。 |
| 被感染的陆战队员 | `StukovInfestedMarine` | `SIInfestedMarine, SICocoonInfestedMarine` | Ground; Biological/Light | 矿:15 气:- 人口字段:-1 生命:50 护盾:- 能量:- | 通用型被感染的步兵。 / 可以对地和对空。 |
| 被感染的平民 | `StukovInfestedCivilian` | `SIInfestedCivilian, SICocoonInfestedSCV` | Ground; Biological/Light | 矿:- 气:- 人口字段:-0.5 生命:35 护盾:- 能量:- | 通用型被感染的步兵。 / 可以对地。 |
| 被感染的怨灵战机 | `StukovInfestedWraith` | `SIWraith, SICocoonInfestedLiberator` | Air; Armored/Mechanical | 矿:150 气:150 人口字段:-2 生命:140 护盾:- 能量:200 | 高度机动性空中单位。擅长突袭打击。 / 可以对空和对地 |
...
| ... | ... | ... | ... | ... | 还有 25 项，后续从 command_cards.json 继续展开 |
...
[XM_DBG][INFO][ROSTER_LOAD] commander=Stukov stage=power_fusion units=5 buildings=10 heroes=0 result=ok
