...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| Karax | https://starcraft2coop.com/commanders/karax.php | 0 | 3 | 0 | 0 | 无 |
| Artanis | https://starcraft2coop.com/commanders/artanis | 0 | 6 | 0 | 0 | 无 |
| Vorazun | https://starcraft2coop.com/commanders/vorazun | 0 | 5 | 0 | 0 | 无 |
...
### global-only 提醒
- 折跃侦察机 `Scout`：HaveFenixScoutWeaponRange
- 航母 `Carrier`：Interceptor、GravitonCatapult
...
### global-only 提醒
- 不朽者 `ImmortalAiur`：ShadowCannonLocked、ImmortalShakurasShadowCannon
- 狂热者 `Zealot`：Charge
- 高阶圣堂武士 `HighTemplar`：Feedback、PsiStorm、AWrp
...
### global-only 提醒
- 海盗船 `PhoenixShakuras`：CorsairMPDisruptionWeb
- 狂热者 `Zealot`：Charge、WhirlwindLocked
- 百夫长 `ZealotShakuras`：WarpInSupplicant
- 虚空辉光舰 `VoidRay`：VoidRaySwarmDamageBoost
