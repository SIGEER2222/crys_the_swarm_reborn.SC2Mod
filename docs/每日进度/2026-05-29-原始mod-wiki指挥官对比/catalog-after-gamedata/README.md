...
- Profile 使用的 Catalog ID：1028
- Profile 使用的 manual fallback ID：83
- Profile 使用的 metadata-only 本地节点：135
- 递归依赖风险行：512
- 未解析引用：4
- 仅由 XM 依赖模块提供：271
- 仅由官方导出引用提供：237
...
输出目录：`docs/每日进度/2026-05-29-原始mod-wiki指挥官对比/catalog-after-gamedata`
