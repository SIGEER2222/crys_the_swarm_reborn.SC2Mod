...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 8 | 10 | 0 | 2 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 10 | 0 | 0 |

## 三方对照

| Wiki项 | 匹配 | 分类 | 官方名称 | ID | 当前Mod | 生产链状态 | 生产/建造/变形 | 数值 | 定义文件 | 备注 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 死徒 | 精确匹配 | 单位 | 死徒 | Supplicant | XM共享模块CUnit：Supplicant；官方合作镜像CUnit：Supplicant | 生产链在底层基础镜像命中，需实机确认 active 是否继承 | Gateway / GatewayTrain / 75晶体矿，28秒 | 生命75，护盾125，人口2，视野9；75晶体矿，28秒 | 原始mod/Mods/XM/XMFinal.SC2Mod/Base.SC2Data/GameData/UnitData.xml<br>游戏数据/官方SC2原始文本镜像/mods/starcoop/starcoop.sc2mod/base.sc2data/gamedata/unitdata.xml |  |
| 杀戮者 | 别名匹配 | 单位 | 追猎者 | Stalker | XM共享模块CUnit：Stalker；底层基础镜像CUnit：Stalker；官方合作镜像CUnit：Stalker | 生产链在底层基础镜像命中，需实机确认 active 是否继承 | Gateway / GatewayTrain / 125晶体矿，50瓦斯，38秒 | 生命80，护盾80，人口2，视野10；125晶体矿，50瓦斯，38秒 | 原始mod/Mods/XM/XMFinal.SC2Mod/Base.SC2Data/GameData/UnitData.xml<br>游戏数据/官方SC2原始文本镜像/campaigns/void.sc2campaign/base.sc2data/gamedata/unitdata.xml<br>游戏数据/官方SC2原始文本镜像/mods/voidmulti.sc2mod/base.sc2data/gamedata/unitdata.xml<br>游戏数据/官方SC2原始文本镜像/mods/swarmmulti.sc2mod/base.sc2data/gamedata/unitdata.xml |  |
| 浩劫 | 精确匹配 | 单位 | 浩劫 | Monitor | XM共享模块CUnit：Monitor；底层基础镜像CUnit：Monitor；官方合作镜像CUnit：Monitor | 生产链在底层基础镜像命中，需实机确认 active 是否继承 | Gateway / GatewayTrain / 37秒 | 37秒 | 原始mod/Mods/XM/XMFinal.SC2Mod/Base.SC2Data/GameData/UnitData.xml<br>游戏数据/官方SC2原始文本镜像/campaigns/void.sc2campaign/base.sc2data/gamedata/unitdata.xml<br>游戏数据/官方SC2原始文本镜像/mods/starcoop/starcoop.sc2mod/base.sc2data/gamedata/unitdata.xml |  |
| 晋升者 | 精确匹配 | 单位 | 晋升者 | HighTemplarTaldarim | XM共享模块CUnit：HighTemplarTaldarim；底层基础镜像CUnit：HighTemplarTaldarim；官方合作镜像CUnit：HighTemplarTaldarim | 生产链在底层基础镜像命中，需实机确认 active 是否继承 | Gateway / GatewayTrain / 55秒 | 55秒 | 原始mod/Mods/XM/XMFinal.SC2Mod/Base.SC2Data/GameData/UnitData.xml<br>游戏数据/官方SC2原始文本镜像/campaigns/void.sc2campaign/base.sc2data/gamedata/unitdata.xml<br>游戏数据/官方SC2原始文本镜像/mods/starcoop/starcoop.sc2mod/base.sc2data/gamedata/unitdata.xml |  |
| 先锋 | 别名匹配 | 单位 | 无情先锋 | ImmortalTaldarim | XM共享模块CUnit：ImmortalTaldarim；底层基础镜像CUnit：ImmortalTaldarim；官方合作镜像CUnit：ImmortalTaldarim | 生产链在底层基础镜像命中，需实机确认 active 是否继承 | 未知生产者 / RoboticsFacilityWarpTrain |  | 原始mod/Mods/XM/XMFinal.SC2Mod/Base.SC2Data/GameData/UnitData.xml<br>游戏数据/官方SC2原始文本镜像/campaigns/void.sc2campaign/base.sc2data/gamedata/unitdata.xml<br>游戏数据/官方SC2原始文本镜像/mods/starcoop/starcoop.sc2mod/base.sc2data/gamedata/unitdata.xml |  |
| 天罚行者 | 精确匹配 | 单位 | 天罚行者 | ColossusTaldarim | XM共享模块CUnit：ColossusTaldarim；底层基础镜像CUnit：ColossusTaldarim；官方合作镜像CUnit：ColossusTaldarim | 生产链在底层基础镜像命中，需实机确认 active 是否继承 | 未知生产者 / RoboticsFacilityWarpTrain |  | 原始mod/Mods/XM/XMFinal.SC2Mod/Base.SC2Data/GameData/UnitData.xml<br>游戏数据/官方SC2原始文本镜像/campaigns/void.sc2campaign/base.sc2data/gamedata/unitdata.xml<br>游戏数据/官方SC2原始文本镜像/mods/starcoop/starcoop.sc2mod/base.sc2data/gamedata/unitdata.xml |  |
| 战争棱镜 | 精确匹配 | 单位 | 战争棱镜 | WarpPrismTaldarim | XM共享模块CUnit：WarpPrismTaldarim；官方合作镜像CUnit：WarpPrismTaldarim | 生产链在底层基础镜像命中，需实机确认 active 是否继承 | RoboticsFacility / RoboticsFacilityTrain / 200晶体矿，50秒 | 生命100，护盾100，人口2，视野10；200晶体矿，50秒 | 原始mod/Mods/XM/XMFinal.SC2Mod/Base.SC2Data/GameData/UnitData.xml<br>游戏数据/官方SC2原始文本镜像/mods/starcoop/starcoop.sc2mod/base.sc2data/gamedata/unitdata.xml |  |
