...
| 掠夺者 | Wiki补充ID | 单位 | 掠夺者 | Reaver | XM共享模块CUnit：Reaver；底层基础镜像CUnit：Reaver；官方合作镜像CUnit：Reaver | 官方JSON无生产链 |  |  | 原始mod/Mods/XM/XMFinal.SC2Mod/Base.SC2Data/GameData/UnitData.xml<br>游戏数据/官方SC2原始文本镜像/campaigns/void.sc2campaign/base.sc2data/gamedata/unitdata.xml<br>游戏数据/官方SC2原始文本镜像/mods/starcoop/starcoop.sc2mod/base.sc2data/gamedata/unitdata.xml | wiki主要部队补充：此处为星灵掠夺者/Reaver，不是人族劫掠者。 |
...
| 凤凰 | 精确匹配 | 单位 | 凤凰 | PhoenixAiur | XM共享模块CUnit：PhoenixAiur；底层基础镜像CUnit：PhoenixAiur；官方合作镜像CUnit：PhoenixAiur | 生产链在底层基础镜像命中，需实机确认 active 是否继承 | 未知生产者 / StargateWarpTrain |  | 原始mod/Mods/XM/XMFinal.SC2Mod/Base.SC2Data/GameData/UnitData.xml<br>游戏数据/官方SC2原始文本镜像/campaigns/void.sc2campaign/base.sc2data/gamedata/unitdata.xml<br>游戏数据/官方SC2原始文本镜像/mods/starcoop/starcoop.sc2mod/base.sc2data/gamedata/unitdata.xml |  |
| 风暴战舰 | Wiki补充ID | 单位 | 风暴战舰 | Tempest | XM共享模块CUnit：Tempest；底层基础镜像CUnit：Tempest；官方合作镜像CUnit：Tempest | 官方JSON无生产链 |  |  | 原始mod/Mods/XM/XMFinal.SC2Mod/Base.SC2Data/GameData/UnitData.xml<br>游戏数据/官方SC2原始文本镜像/campaigns/void.sc2campaign/base.sc2data/gamedata/unitdata.xml<br>游戏数据/官方SC2原始文本镜像/mods/voidmulti.sc2mod/base.sc2data/gamedata/unitdata.xml<br>游戏数据/官方SC2原始文本镜像/mods/void.sc2mod/base.sc2data/gamedata/unitdata.xml | wiki主要部队补充：按风暴战舰ID检查当前Mod。 |
...
|  | 官方补充 | 建筑 | 折跃机械台 | RoboticsFacilityWarp | XM共享模块CUnit：RoboticsFacilityWarp；底层基础镜像CUnit：RoboticsFacilityWarp；官方合作镜像CUnit：RoboticsFacilityWarp | 生产链在底层基础镜像命中，需实机确认 active 是否继承 | Probe / ProtossBuild / 65秒 | 65秒 | 原始mod/Mods/XM/XMFinal.SC2Mod/Base.SC2Data/GameData/UnitData.xml<br>游戏数据/官方SC2原始文本镜像/campaigns/void.sc2campaign/base.sc2data/gamedata/unitdata.xml<br>游戏数据/官方SC2原始文本镜像/mods/starcoop/starcoop.sc2mod/base.sc2data/gamedata/unitdata.xml | 官方JSON有，wiki主要部队未列。 |
...
| 建筑 | 折跃机械台 | RoboticsFacilityWarp | XM共享模块CUnit：RoboticsFacilityWarp；底层基础镜像CUnit：RoboticsFacilityWarp；官方合作镜像CUnit：RoboticsFacilityWarp | Probe / ProtossBuild / 65秒 | 65秒 |
