...
| 虫巢女王 | 别名匹配 | 单位 | 虫后 | SwarmQueen | CUnit已定义：SwarmQueen | 技能缺失 TrainQueen | Hatchery / TrainQueen / 50秒 | 50秒 | Mods/XM/XMFinal.SC2Mod/Base.SC2Data/GameData/UnitData.xml |  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 虫巢女王 | 别名匹配 | 单位 | 虫后 | SwarmQueen | CUnit已定义：SwarmQueen | 技能缺失 TrainQueen | Hatchery / TrainQueen / 50秒 | 50秒 |
