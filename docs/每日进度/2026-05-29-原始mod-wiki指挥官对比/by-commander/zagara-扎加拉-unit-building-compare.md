...
| 爆虫 | 精确匹配 | 单位 | 爆虫 | Baneling | 底层基础镜像CUnit：Baneling；官方合作镜像CUnit：Baneling | 生产链已命中 | Zergling / MorphZerglingToBaneling / 25晶体矿，25瓦斯，20秒 | 生命30，人口0.5，视野8；25晶体矿，25瓦斯，20秒 | 游戏数据/官方SC2原始文本镜像/campaigns/void.sc2campaign/base.sc2data/gamedata/unitdata.xml<br>游戏数据/官方SC2原始文本镜像/mods/voidmulti.sc2mod/base.sc2data/gamedata/unitdata.xml<br>游戏数据/官方SC2原始文本镜像/mods/swarmmulti.sc2mod/base.sc2data/gamedata/unitdata.xml<br>游戏数据/官方SC2原始文本镜像/mods/swarm.sc2mod/base.sc2data/gamedata/unitdata.xml |  |
| 畸变体 | 精确匹配 | 单位 | 畸变体 | InfestedAbomination | XM共享模块CUnit：InfestedAbomination；底层基础镜像CUnit：InfestedAbomination；官方合作镜像CUnit：InfestedAbomination | 生产链在 XMFinal 运行闭包命中 | SILarva / SILarvaTrain / 30秒 | 30秒 | 原始mod/Mods/XM/XMFinal.SC2Mod/Base.SC2Data/GameData/UnitData.xml<br>游戏数据/官方SC2原始文本镜像/campaigns/void.sc2campaign/base.sc2data/gamedata/unitdata.xml<br>游戏数据/官方SC2原始文本镜像/mods/starcoop/starcoop.sc2mod/base.sc2data/gamedata/unitdata.xml |  |
| 爆蚊 | 精确匹配 | 单位 | 爆蚊 | Scourge | XM共享模块CUnit：Scourge；官方合作镜像CUnit：Scourge | 技能仅在官方合作镜像：LarvaTrainSwarm | Larva / LarvaTrainSwarm / 1晶体矿，1瓦斯，30秒 | 1晶体矿，1瓦斯，30秒 | 原始mod/Mods/XM/XMFinal.SC2Mod/Base.SC2Data/GameData/UnitData.xml<br>游戏数据/官方SC2原始文本镜像/mods/starcoop/starcoop.sc2mod/base.sc2data/gamedata/unitdata.xml |  |
| 腐化者 | 精确匹配 | 单位 | 腐化者 | Corruptor | 底层基础镜像CUnit：Corruptor；官方合作镜像CUnit：Corruptor | 生产链在底层基础镜像命中，需实机确认 active 是否继承 | Larva / LarvaTrain / 150晶体矿，100瓦斯，40秒 | 生命200，人口2，视野10；150晶体矿，100瓦斯，40秒 | 游戏数据/官方SC2原始文本镜像/mods/voidmulti.sc2mod/base.sc2data/gamedata/unitdata.xml<br>游戏数据/官方SC2原始文本镜像/mods/swarm.sc2mod/base.sc2data/gamedata/unitdata.xml<br>游戏数据/官方SC2原始文本镜像/mods/libertymulti.sc2mod/base.sc2data/gamedata/unitdata.xml<br>游戏数据/官方SC2原始文本镜像/mods/liberty.sc2mod/base.sc2data/gamedata/unitdata.xml |  |
...
| 胆汁喷射体 | Wiki补充ID | 建筑 | 胆汁喷射体 | BileLauncherZagara | XM共享模块CUnit：BileLauncherZagara；官方合作镜像CUnit：BileLauncherZagara | 官方JSON无生产链 |  |  | 原始mod/Mods/XM/XMFinal.SC2Mod/Base.SC2Data/GameData/UnitData.xml<br>游戏数据/官方SC2原始文本镜像/mods/starcoop/starcoop.sc2mod/base.sc2data/gamedata/unitdata.xml | wiki主要部队补充：按扎加拉胆汁喷射体ID检查当前Mod。 |
|  | 官方补充 | 英雄 | 扎加拉 | ZagaraVoidCoop | XM共享模块CUnit：ZagaraVoidCoop；官方合作镜像CUnit：ZagaraVoidCoop | 官方JSON无生产链 |  | 生命600，视野13 | 原始mod/Mods/XM/XMFinal.SC2Mod/Base.SC2Data/GameData/UnitData.xml<br>游戏数据/官方SC2原始文本镜像/mods/starcoop/starcoop.sc2mod/base.sc2data/gamedata/unitdata.xml | 官方JSON有，wiki主要部队未列。 |

## 优先排查项

| Wiki项 | 匹配 | 分类 | 官方名称 | ID | 当前Mod | 生产链状态 | 生产/建造/变形 | 数值 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 爆蚊 | 精确匹配 | 单位 | 爆蚊 | Scourge | XM共享模块CUnit：Scourge；官方合作镜像CUnit：Scourge | 技能仅在官方合作镜像：LarvaTrainSwarm | Larva / LarvaTrainSwarm / 1晶体矿，1瓦斯，30秒 | 1晶体矿，1瓦斯，30秒 |
...
| --- | --- | --- | --- | --- | --- |
| 英雄 | 扎加拉 | ZagaraVoidCoop | XM共享模块CUnit：ZagaraVoidCoop；官方合作镜像CUnit：ZagaraVoidCoop | 官方JSON无生产链 | 生命600，视野13 |
