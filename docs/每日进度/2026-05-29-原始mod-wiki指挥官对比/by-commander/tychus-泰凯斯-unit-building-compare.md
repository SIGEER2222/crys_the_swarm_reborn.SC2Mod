...
| 自动机炮 | Wiki补充ID | 建筑 | 自动机炮 | TychusWarhoundAutoTurret | CUnit已定义：TychusWarhoundAutoTurret | 官方JSON无生产链 |  |  | Mods/XM/XMTychus.SC2Mod/Base.SC2Data/GameData/UnitData.xml | wiki主要部队补充：泰凯斯自动机炮使用战狼炮塔ID，不使用诺娃/通用自动炮塔ID。 |
