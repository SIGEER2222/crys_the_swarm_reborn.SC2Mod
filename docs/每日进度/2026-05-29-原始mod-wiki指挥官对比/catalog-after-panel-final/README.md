...
- Profile 使用的 Catalog ID：1112
- Profile 使用的 manual fallback ID：83
- Profile 使用的 metadata-only 本地节点：144
- 递归依赖风险行：696
- 未解析引用：4
- 仅由 XM 依赖模块提供：295
- 仅由官方导出引用提供：397
...
| ability | HHWraithCloak | Horner | ability-with-chain | no | 4 | 1 | 3 |
...
| ability | ViperConsumeStructure | Abathur | manual-ability-stub | yes | 0 | 0 | 0 |
...
输出目录：`docs/每日进度/2026-05-29-原始mod-wiki指挥官对比/catalog-after-panel-final`
