...
### 2. 毒巢网络
- 花费：10
- Upgrade：`AbathurBiomassLifeLeech`
...
### 6. 空中终极进化
- 花费：20
- Upgrade：`AbathurEnableSymbiote`
- 描述：允许空中单位通过生物质阈值进化为利维坦。
- 具体效果：
  - 影响单位：莽兽、利维坦
  - 莽兽共生体挂载：InfoArray[Ammo1].初始数量 +1
  - 利维坦共生体挂载：InfoArray[Ammo1].初始数量 +1

### 7. 变异甲壳
- 花费：25
- Upgrade：`AbathurMorphTimeCostReduced`
...
### 8. 巢群强化
- 花费：30
- Upgrade：`AbathurToxicNestIcreasedBiomass`
...
### 1. 生物质效率
- Upgrade：`MasteryAbathurDoubleBiomass`
- 描述：提高生物质掉落、拾取与成长收益。
- 具体效果：
  - 最高等级：30
  - 生物质效率显示值：效果数值 +1.5
...
### 2. 毒巢强化
- Upgrade：`AbathurToxicNestRespawnTalent`
- 描述：强化毒巢充能、爆发与相关衍生效果。
- 具体效果：
  - 影响单位：剧毒巢穴
  - 剧毒巢穴复生：触发概率 设为 0.6
...
### 4. 终极进化生命值
- Upgrade：`MasteryAbathurSymbioteCarapace`
- 描述：提高终极进化单位的生命值上限。
- 具体效果：
  - 最高等级：30
...
### 5. 进化单位攻击
- Upgrade：`MasteryAbathurSymbioteCDR`
- 描述：提高进化单位与主力部队的攻击表现。
- 具体效果：
  - 最高等级：30
  - 进化单位攻击显示值：效果数值 +2
...
### 6. 恢复强化
- Upgrade：`MasteryAbathurBiomassRefund`
- 描述：提高恢复效果与持续作战续航。
- 具体效果：
  - 最高等级：30
  - 恢复强化显示值：效果数值 +1
