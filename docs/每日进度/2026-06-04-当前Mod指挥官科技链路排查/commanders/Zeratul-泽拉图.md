...
| --- | --- | --- | --- | --- | --- |
| 初始基地 / Command Center | `Nexus` | building | - | 否 / No | Catalog xmcore，Instance Zeratul，文件 / File `合作指挥官版起义狂潮/Mods/XM/XMCore.SC2Mod/Base.SC2Data/GameData/UserData.xml` |
| 初始工人 / Worker | `Probe` | unit | - | 否 / No | Catalog xmcore，Instance Zeratul，文件 / File `合作指挥官版起义狂潮/Mods/XM/XMCore.SC2Mod/Base.SC2Data/GameData/UserData.xml` |
| 第二初始单位 / Second Unit | `Pylon` | unit | - | 否 / No | Catalog xmcore，Instance Zeratul，文件 / File `合作指挥官版起义狂潮/Mods/XM/XMCore.SC2Mod/Base.SC2Data/GameData/UserData.xml` |
