...
| `SOAPurifierBeam` | `SOAPurifierBeam,Execute` | 目标效果技能 / CAbilEffectTarget | 创建单位效果 / CEffectCreateUnit:`SOAPurifierBeamCU`、区域枚举效果 / CEffectEnumArea:`SOAPurifierBeamSearch` | xmkarax:1 |
