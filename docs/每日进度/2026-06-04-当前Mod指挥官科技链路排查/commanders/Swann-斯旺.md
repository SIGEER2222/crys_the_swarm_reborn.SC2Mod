...
- 统计 / Stats：建筑 15、生产链补充建筑 0、单位 15、英雄 0、建筑按钮 77、单位按钮 74、效果引用 19
...
| --- | --- | --- | --- | --- | --- |
| 初始基地 / Command Center | 指挥中心 / `CommandCenterSwann` | building | - | 是 / Yes | Catalog xmswann，Instance Swann，文件 / File `合作指挥官版起义狂潮/Mods/XM/XMSwann.SC2Mod/Base.SC2Data/GameData/UserData.xml`，名册状态 / Roster status alias |
| 初始工人 / Worker | `SCVSwann` | unit | - | 是 / Yes | Catalog xmswann，Instance Swann，文件 / File `合作指挥官版起义狂潮/Mods/XM/XMSwann.SC2Mod/Base.SC2Data/GameData/UserData.xml`，名册状态 / Roster status alias |
| 第二初始单位 / Second Unit | 德拉肯激光钻机 / `UnfinishedDrakkenLaserDrillCoop` | unit | - | 否 / No | Catalog xmswann，Instance Swann，文件 / File `合作指挥官版起义狂潮/Mods/XM/XMSwann.SC2Mod/Base.SC2Data/GameData/UserData.xml` |
...
- 可生产/创建 / Produced or created：`UnfinishedDrakkenLaserDrillCoop`（非本指挥官名册 / not in current commander roster）
...
| --- | --- | --- | --- | --- | --- | --- |
| 0,4 | `BrokenDrakkenLaserDrill` | `BrokenDrakkenLaserDrill,Execute` | 变形技能 / CAbilMorph | 单位 / Unit:`UnfinishedDrakkenLaserDrillCoop` | - | - |
...
- 可生产/创建 / Produced or created：`SupplyDepotSwannLowered`（非本指挥官名册 / not in current commander roster）
- 已隐藏基础按钮 / Hidden basic buttons：3 个（用 `--include-basic` 可展开 / use `--include-basic` to expand）

| 位置 / Slot | 面板按钮 / Panel Button | Ability/Cmd | 类型 / Type | 生产/研究目标 / Production or Research Target | 效果引用 / Effect References | 需求 / Requirements |
| --- | --- | --- | --- | --- | --- | --- |
| 2,0 | `SupplyDepotLoweSwannR` | `SupplyDepotLoweSwannR,0` | 变形技能 / CAbilMorph | 单位 / Unit:`SupplyDepotSwannLowered` | - | - |
