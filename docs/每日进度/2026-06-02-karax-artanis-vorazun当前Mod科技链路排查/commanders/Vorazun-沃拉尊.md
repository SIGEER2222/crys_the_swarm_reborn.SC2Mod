...
- 统计 / Stats：建筑 4、生产链补充建筑 2、单位 8、英雄 2、建筑按钮 17、单位按钮 24、效果引用 15
...
| --- | --- | --- | --- | --- | --- |
| 初始基地 / Command Center | `Nexus` | building | - | 否 / No | Catalog xmcore，Instance Vorazun，文件 / File `合作指挥官版起义狂潮/Mods/XM/XMCore.SC2Mod/Base.SC2Data/GameData/UserData.xml` |
| 初始工人 / Worker | `Probe` | unit | - | 否 / No | Catalog xmcore，Instance Vorazun，文件 / File `合作指挥官版起义狂潮/Mods/XM/XMCore.SC2Mod/Base.SC2Data/GameData/UserData.xml` |
| 第二初始单位 / Second Unit | `DarkPylon` | unit | - | 是 / Yes | Catalog xmcore，Instance Vorazun，文件 / File `合作指挥官版起义狂潮/Mods/XM/XMCore.SC2Mod/Base.SC2Data/GameData/UserData.xml`，名册状态 / Roster status galaxy |
...
| --- | --- | --- | --- | --- | --- |
| 部署黑暗水晶塔 / `SOADarkPylon` | `SOADarkPylon,Build1` | 建造技能 / CAbilBuild | `DarkPylon` | - | xmvorazun:1 |
| 黑洞 / `VoidSentryBlackHole` | `VoidSentryBlackHole,Execute` | 目标效果技能 / CAbilEffectTarget | - | - | xmvorazun:1 |
| 部署暗影卫队 / `SOAShadowGuardCalldown` | `SOAShadowGuardCalldown,Execute` | 目标效果技能 / CAbilEffectTarget | `VorazunShadowGuard` | 创建单位效果 / CEffectCreateUnit:`ShadowGuardCU` | xmvorazun:1 |
| `SOATimeFreeze` | `SOATimeFreeze,Execute` | 瞬发效果技能 / CAbilEffectInstant | - | 持续效果 / CEffectCreatePersistent:`SOATimeFreeze` | xmvorazun:1 |
| `CommanderPrestigeVorazunTimeStop` | `CommanderPrestigeVorazunTimeStop,Execute` | 目标效果技能 / CAbilEffectTarget | `VorazunShadowGuard` | 效果集合 / CEffectSet:`CommanderPrestigeVorazunTimeStop` | xmvorazun:1 |
...
- 来源 / Source：名册 / Roster XMFinal CommanderRuntimeRoster + XMFinal CommanderRosters.galaxy，状态 / Status exact，模块 / Module XMVorazun.SC2Mod，文件 / File `合作指挥官版起义狂潮/Mods/XM/XMFinal.SC2Mod/Base.SC2Data/GameData/UserData.xml`
- 数值 / Stats：费用 / Cost 100/75
- Catalog 技能链接 / Catalog ability links：`OracleRevelation`(目标效果技能 / CAbilEffectTarget)、`OracleStasisTrapBuild`(建造技能 / CAbilBuild)、`OracleWeapon`(行为/被动技能 / CAbilBehavior)
- 关联 Behavior / Linked behaviors：`AllUnitBehaviorController`、`CorsairPermanentCloak`、`VorazunCloakedShieldRegenPermanent`
- 可生产/创建 / Produced or created：`OracleStasisTrap`（非本指挥官名册 / not in current commander roster），耗时 / Time 5s

| 位置 / Slot | 面板按钮 / Panel Button | Ability/Cmd | 类型 / Type | 生产/研究目标 / Production or Research Target | 效果引用 / Effect References | 需求 / Requirements |
| --- | --- | --- | --- | --- | --- | --- |
| 2,0 | `OracleRevelation` | `OracleRevelation,Execute` | 目标效果技能 / CAbilEffectTarget | - | 区域枚举效果 / CEffectEnumArea:`OracleRevelationSearch` | - |
| 2,1 | `OracleStasisTrapBuild` | `OracleStasisTrapBuild,Build1` | 建造技能 / CAbilBuild | `OracleStasisTrap`、单位 / Unit:`OracleStasisTrap` | 伤害效果 / CEffectDamage:`OracleStasisTrapBuildBeamOff`、伤害效果 / CEffectDamage:`OracleStasisTrapBuildBeamOn` | - |
| 2,2 | `OracleWeapon` | `OracleWeapon,On` | 行为/被动技能 / CAbilBehavior | - | - | - |
...
- 来源 / Source：名册 / Roster XMFinal CommanderRuntimeRoster + XMFinal CommanderRosters.galaxy，状态 / Status exact，模块 / Module XMVorazun.SC2Mod，文件 / File `合作指挥官版起义狂潮/Mods/XM/XMFinal.SC2Mod/Base.SC2Data/GameData/UserData.xml`
- 数值 / Stats：类型 / Type Unit
- Catalog 技能链接 / Catalog ability links：`Charge`(CAbilAugment / CAbilAugment)
- 关联 Behavior / Linked behaviors：`AllUnitBehaviorController`
...
- 来源 / Source：名册 / Roster XMFinal CommanderRuntimeRoster + XMFinal CommanderRosters.galaxy，状态 / Status exact，模块 / Module XMVorazun.SC2Mod，文件 / File `合作指挥官版起义狂潮/Mods/XM/XMFinal.SC2Mod/Base.SC2Data/GameData/UserData.xml`
- 数值 / Stats：无 / None
- Catalog 技能链接 / Catalog ability links：`VoidRaySwarmDamageBoost`(瞬发效果技能 / CAbilEffectInstant)
- 关联 Behavior / Linked behaviors：`AllUnitBehaviorController`

| 位置 / Slot | 面板按钮 / Panel Button | Ability/Cmd | 类型 / Type | 生产/研究目标 / Production or Research Target | 效果引用 / Effect References | 需求 / Requirements |
| --- | --- | --- | --- | --- | --- | --- |
| 2,0 | `VoidRaySwarmDamageBoost` | `VoidRaySwarmDamageBoost,Execute` | 瞬发效果技能 / CAbilEffectInstant | - | - | - |
