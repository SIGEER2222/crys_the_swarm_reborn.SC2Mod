...
$seedIds = @(
    ...
    "KerriganHeroicFortitude", "K5HeroicFortitude", "KerriganPrimalRage",
    ...
    "CommanderPrestigeKerriganAssimilationAuraShared", "CommanderPrestigeKerriganMalignantCreep",
    "HaveMasteryKerriganAssimilationAuraDuration", "HaveMasteryKerriganLarvaRate",
