...
const aliases = {
  Kerrigan: {
    ...
    QueenCoop: ["QueenCoop", "SwarmQueen"],
    Zergling: ["Zergling", "HotSRaptor"],
    HotSRaptor: ["HotSRaptor", "Zergling"],
  },
  Nova: {
    ...
    AutoTurret: ["AutoTurret", "AutoTurret_BlackOps", "NovaACLaserTurret"],
    AutoTurret_BlackOps: ["AutoTurret_BlackOps", "AutoTurret", "NovaACLaserTurret"],
    NovaACLaserTurret: ["NovaACLaserTurret", "AutoTurret"],
    Barracks: ["Barracks", "BarracksNova"],
    BarracksNova: ["BarracksNova", "Barracks"],
    CommandCenter: ["CommandCenter", "CommandCenterNova"],
    CommandCenterNova: ["CommandCenterNova", "CommandCenter"],
    Factory: ["Factory", "FactoryNova"],
    FactoryNova: ["FactoryNova", "Factory"],
    MissileTurret: ["MissileTurret", "MissileTurretNova"],
    MissileTurretNova: ["MissileTurretNova", "MissileTurret"],
    SCV: ["SCV", "SCVNova"],
    SCVNova: ["SCVNova", "SCV"],
  },
  Raynor: {
  ...
  Swann: {
    Armory: ["Armory", "ArmorySwann"],
    ArmorySwann: ["ArmorySwann", "Armory"],
    Barracks: ["Barracks", "BarracksSwann"],
    BarracksSwann: ["BarracksSwann", "Barracks"],
    CommandCenter: ["CommandCenter", "CommandCenterSwann"],
    CommandCenterSwann: ["CommandCenterSwann", "CommandCenter"],
    EngineeringBay: ["EngineeringBay", "EngineeringBaySwann"],
    EngineeringBaySwann: ["EngineeringBaySwann", "EngineeringBay"],
    Factory: ["Factory", "FactorySwann"],
    FactorySwann: ["FactorySwann", "Factory"],
    Goliath: ["Goliath", "GoliathSwann"],
    GoliathSwann: ["GoliathSwann", "Goliath"],
    Hercules: ["Hercules", "HerculesSwann"],
    HerculesSwann: ["HerculesSwann", "Hercules"],
    ScienceVessel: ["ScienceVessel", "ScienceVesselSwann"],
    ScienceVesselSwann: ["ScienceVesselSwann", "ScienceVessel"],
    Wraith: ["Wraith", "WraithSwann"],
    WraithSwann: ["WraithSwann", "Wraith"],
    KelMorianGrenadeTurret: ["KelMorianGrenadeTurret", "GrenadeTurretSwann"],
    GrenadeTurretSwann: ["GrenadeTurretSwann", "KelMorianGrenadeTurret"],
    PerditionTurret: ["PerditionTurret", "PerditionTurretSwann"],
    PerditionTurretSwann: ["PerditionTurretSwann", "PerditionTurret"],
    SupplyDepot: ["SupplyDepot", "SupplyDepotSwann"],
    SupplyDepotSwann: ["SupplyDepotSwann", "SupplyDepot"],
    MissileTurret: ["MissileTurret", "MissileTurretSwann"],
    MissileTurretSwann: ["MissileTurretSwann", "MissileTurret"],
    SCV: ["SCV", "SCVSwann"],
    SCVSwann: ["SCVSwann", "SCV"],
  },
  Stukov: {
