...
const manualFallbackNodes = {
  button: new Map([
    ...
    ["ImmortalShakurasShadowCannon", buttonStubWithIcon("ImmortalShakurasShadowCannon", "Assets\\Textures\\btn-ability-protoss-shadowcannon.dds")],
    ["HaveAnionPulseCrystals", buttonStubWithIcon("HaveAnionPulseCrystals", "Assets\\Textures\\btn-upgrade-protoss-phoenixrange.dds")],
    ["GravitonBeamVoidCampaign", buttonStubWithIcon("GravitonBeamVoidCampaign", "Assets\\Textures\\btn-ability-protoss-gravitonbeam-color.dds")],
    ["VoidDarkTemplarShadowFury", buttonStubWithIcon("VoidDarkTemplarShadowFury", "Assets\\Textures\\btn-ability-protoss-shadowfury.dds")],
    ["ZerglingBurrowMove", buttonStubWithIcon("ZerglingBurrowMove", "Assets\\Textures\\btn-ability-zerg-burrow-color.dds")],
    ["HotSRoachShield", buttonStub("HotSRoachShield")],
    ["SwarmHostRootBurrow", buttonStubWithIcon("SwarmHostRootBurrow", "Assets\\Textures\\btn-ability-zerg-burrow-color.dds")],
    ["VilePassive", buttonStub("VilePassive")],
    ["CommanderAbathurBrutaliskSymbiote", buttonStub("CommanderAbathurBrutaliskSymbiote")],
    ["TissueAssimilation", buttonStub("TissueAssimilation")],
    ["K5ZerglingRespawn", buttonStub("K5ZerglingRespawn")],
    ["K5Cooldowns", buttonStub("K5Cooldowns")],
    ["SpawnBanelings", buttonStub("SpawnBanelings")],
    ["K5DropPods", buttonStub("K5DropPods")],
    ["K5Fury", buttonStub("K5Fury")],
    ["K5HeroicFortitude", buttonStub("K5HeroicFortitude")],
    ["PrimalHeal", buttonStub("PrimalHeal")],
    ["WildMutation", buttonStub("WildMutation")],
    ["ChainReaction", buttonStub("ChainReaction")],
    ["RavagerStetmann", buttonStub("RavagerStetmann")],
    ["LurkerBurrowDown", buttonStubWithIcon("LurkerBurrowDown", "Assets\\Textures\\btn-ability-zerg-burrow-color.dds")],
    ["SingularityAnchor", buttonStub("SingularityAnchor")],
    ["ZagaraVoidCoopSpawnHunterKillers", buttonStub("ZagaraVoidCoopSpawnHunterKillers")],
  ]),
  ability: new Map([
    ...
    ["ImmortalBarrierBase", abilityStub("CAbilEffectInstant", "ImmortalBarrierBase", "ImmortalBarrierBase")],
    ["Feedback", abilityStub("CAbilEffectTarget", "Feedback", "Feedback")],
    ["ImmortalOverload", abilityStub("CAbilEffectInstant", "ImmortalOverload", "ImmortalOverload")],
    ["CarrierHangar", abilityCommandStub("CAbilArmMagazine", "CarrierHangar", "Ammo1", "Interceptor")],
    ["GravitonBeamVoidCampaign", abilityStub("CAbilEffectTarget", "GravitonBeamVoidCampaign", "GravitonBeamVoidCampaign")],
    ["OracleStasisTrapBuild", abilityCommandStub("CAbilBuild", "OracleStasisTrapBuild", "Build1", "OracleBuildStasisTrap")],
    ["VoidRaySwarmDamageBoost", abilityStub("CAbilEffectInstant", "VoidRaySwarmDamageBoost", "VoidRaySwarmDamageBoost")],
    ["BurrowUltraliskDown", abilityStub("CAbilMorph", "BurrowUltraliskDown", "BurrowDown")],
    ["BurrowUltraliskUp", abilityStub("CAbilMorph", "BurrowUltraliskUp", "BurrowUp")],
    ["LocustLaunch", abilityStub("CAbilEffectInstant", "LocustLaunch", "LocustLaunch")],
    ["MorphToSwarmHostBurrowed", abilityStub("CAbilMorph", "MorphToSwarmHostBurrowed", "SwarmHostRootBurrow")],
    ["ViperConsumeStructure", abilityStub("CAbilEffectTarget", "ViperConsumeStructure", "ViperConsume")],
    ["Yoink", abilityStub("CAbilEffectTarget", "Yoink", "FaceEmbrace")],
    ["MorphToBaneling", abilityStub("CAbilMorph", "MorphToBaneling", "Baneling")],
    ["SpawnBanelings", abilityStub("CAbilEffectInstant", "SpawnBanelings", "SpawnBanelings")],
    ["K5DropPods", abilityStub("CAbilEffectTarget", "K5DropPods", "K5DropPods")],
    ["VolatileBurstBuilding", abilityCommandStub("CAbilBehavior", "VolatileBurstBuilding", "On", "EnableBuildingAttack")],
    ["LurkerHoldFire", abilityStub("CAbilEffectInstant", "LurkerHoldFire", "LurkerHoldFire")],
    ["LurkerRemoveHoldFire", abilityStub("CAbilEffectInstant", "LurkerRemoveHoldFire", "LurkerCancelHoldFire")],
    ["WraithCloak", behaviorToggleStub("WraithCloak", "WraithCloakOn", "WraithCloakOff")],
    ["MorphToBroodLord", abilityStub("CAbilMorph", "MorphToBroodLord", "BroodLord")],
  ]),
  requirement: new Map([
    ["DynamicPowerRoutingResearched", requirementStub("DynamicPowerRoutingResearched")],
    ["HaveAdeptPiercingAttack", requirementStub("HaveAdeptPiercingAttack")],
    ["HaveK5ChainLightning", requirementStub("HaveK5ChainLightning")],
    ["HaveK5Cooldowns", requirementStub("HaveK5Cooldowns")],
    ["HaveK5Fury", requirementStub("HaveK5Fury")],
    ["HaveK5HeroicFortitude", requirementStub("HaveK5HeroicFortitude")],
    ["HaveLiberatorRange", requirementStub("HaveLiberatorRange")],
    ["HaveUltraliskAnabolicSynthesis", requirementStub("HaveUltraliskAnabolicSynthesis")],
    ["HaveUltraliskChitnousPlating", requirementStub("HaveUltraliskChitnousPlating")],
    ["UseGravitonCatapult", requirementStub("UseGravitonCatapult")],
...
function abilityStub(tag, id, buttonId) {
  return abilityCommandStub(tag, id, "Execute", buttonId);
}

function abilityCommandStub(tag, id, commandIndex, buttonId) {
  return manualNode("ability", tag, id, [
    `<${tag} id="${id}">`,
    `    <CmdButtonArray index="${commandIndex}" DefaultButtonFace="${buttonId}"/>`,
    `</${tag}>`,
  ].join("\n"));
}
