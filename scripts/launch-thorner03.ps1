<#
.SYNOPSIS
Launch thorner03 with a specific commander.

.EXAMPLE
  .\scripts\launch-thorner03.ps1 -Commander Abathur
#>
[CmdletBinding()]
param(
    ...
    [string]$MapPath = "E:\SC2\SC2new\StarCraft II\Maps\XM\thorner03.SC2Map"
)
...
Write-Host "Launching thorner03 with commander: $Commander"
